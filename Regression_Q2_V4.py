...
for train_index, test_index in CV.split(X,y):
    ...
    if k == K-1:
        figure(k, figsize=(20,8))
        subplot(1,2,1)
        semilogx(lambdas,mean_w_vs_lambda.T[:,1:], linewidth=3) # Don't plot the bias term
        ...
        loglog(lambdas,train_err_vs_lambda.T,'b',lambdas,test_err_vs_lambda.T,'r', linewidth=3)
        xlabel('Regularization factor')
